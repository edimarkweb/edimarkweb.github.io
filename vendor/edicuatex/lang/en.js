...
$i18n['eXe'] = {
    ...
    'Quick start': _('Quick start'),
    'Start from empty set': _('Start from empty set'),
    'Start with minimal example': _('Start with minimal example'),
    'Create a new set without loading external files.': _('Create a new set without loading external files.'),
    'Empty set': _('Empty set'),
    'Starter example': _('Starter example'),
    'Rename': _('Rename'),
    'Rename set': _('Rename set'),
    'Set name': _('Set name'),
    'Double-click to rename': _('Double-click to rename'),
    'Close without saving?': _('Close without saving?'),
    'This set has unsaved changes. Close anyway?': _('This set has unsaved changes. Close anyway?'),
