...
En **Importar**, elige un PDF (también puedes arrastrarlo al editor). La conversión se realiza en tu equipo, sin OCR y sin enviar el documento a un servidor. Al abrir el cuadro, el conversor lee el PDF y muestra cuántas páginas contiene antes de permitir generar la vista previa.
