...
- **Importar**: abre Markdown locales, pega documentos LaTeX completos o convierte ficheros mediante Pandoc (DOCX, ODT, EPUB, HTML, TEX). Al arrastrar y soltar se admiten carpetas enteras, que se recorren en busca de archivos compatibles. Las imágenes de los documentos DOCX, ODT y EPUB se extraen del archivo y se incrustan en el Markdown. Los PDF se convierten localmente con Python/WebAssembly (PyMuPDF4LLM sin el motor Layout nativo), sin OCR: incluyen selección de páginas, eliminación opcional de encabezados y pies repetidos, conservación de imágenes y fórmulas detectadas como imágenes, y vista previa antes de abrir una pestaña nueva. Las tablas y fórmulas requieren revisión. El conversor local ocupa unos 34 MB y se carga bajo demanda; se incluye también en el escritorio. Límites: 50 MB por PDF y 200 páginas por conversión.
