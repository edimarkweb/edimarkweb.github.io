...
Podes eliminar cabeceiras e pés repetidos, conservar imaxes e fórmulas detectadas como imaxes, aplicar OCR ás páxinas dixitalizadas e escoller o idioma, e indicar páxinas como `1-3, 5` (baleiro significa todas). As dúas primeiras están activadas inicialmente; o OCR está desactivado, porque descarga un motor de recoñecemento e retarda a conversión. O idioma inicial do OCR coincide co da interface. Preme **Xerar vista previa**, revisa o resultado e despois **Importar nunha pestana nova**. A vista previa amosa as doce primeiras imaxes e só nomea as restantes, que se importan igualmente. Cambiar as opcións require outra vista previa. Cancelar non altera os documentos abertos. Unha barra mostra o progreso ao abrir o conversor, páxina a páxina, durante o recoñecemento, ao preparar a vista previa e ao crear o documento.
