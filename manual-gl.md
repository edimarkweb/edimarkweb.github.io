...
Na aplicación de escritorio, os instaladores rexistran `.md` e `.markdown`; tamén podes abrir estes documentos cun dobre clic desde o xestor de ficheiros.
