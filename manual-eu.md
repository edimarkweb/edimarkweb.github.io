...
Irudiak testuaren barruan joan ez daitezen nahiago baduzu, panel horretako **Irudiak karpetara eraman** botoiak itzulerako bidea egiten du: irudi bakoitza `imagenes/` karpetako fitxategi bihurtzen da eta Markdown-ean bere bidea geratzen da, edozein `.md`-k irudiak gordetzen dituen bezala. Fitxategiak dokumentua gordetzean idazten dira, bidearekiko gainerako irudien bide beretik: `.md`-ren ondoan mahaigaineko aplikazioan, nabigatzailean aukeratzen duzun karpetan eta, nabigatzaileak karpeta aukeratzeko aukerarik ematen ez duenean, ZIParen barruan. Bitartean aurrebistan ikusten jarraitzen dute, eta `Ctrl`+`Z`-k aldaketa desegiten du nahi zenuena ez bazen.
